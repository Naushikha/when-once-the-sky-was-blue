...
class FlyControls extends EventDispatcher {
	...
	constructor( object, domElement ) {
		...
		this.update = function ( delta ) {
			...
			// if (scope.object.rotation.x > 0 && scope.object.rotation.x < Math.PI/1.4) scope.object.rotation.x = Math.PI/1.4;
			// if (scope.object.rotation.x < 0 && scope.object.rotation.x > -Math.PI/1.4) scope.object.rotation.x = -Math.PI/1.4;
			...
			scope.tmpQuaternion.set( scope.rotationVector.x * 0, scope.rotationVector.y * rotMult, scope.rotationVector.z * 0, 1 ).normalize();
